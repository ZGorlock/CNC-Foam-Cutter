...
import tracer.objects.base.simple.Text;
import tracer.objects.polyhedron.Polyhedron;
        ...
        if (faceIndices == null) {
            ...
            for (int i = 0; i < numFaces; i++) {
                if (components.get(i) instanceof Polygon) {
                    faceIndices[i] = new Text(this, Color.RED, Vector.averageVector(((tracer.objects.base.polygon.Polygon) components.get(i)).getVertices()), String.valueOf(i));
                }
            }
        }
